...
- [ ] 2.3 Extract tournament/draft/replay services into dedicated subdirectories and publish them via an index barrel _(tournament socket + presence module complete)_.
- [ ] 2.4 Introduce a lightweight dependency registry so feature modules can register handlers without touching the entrypoint.
