...
describe('SocketTransport', () => {
  ...
  describe('Connection State', () => {
    ...
    it('should report not connected if socket missing', () => {
      transport['connectionState'] = 'connected';
    ...
    it('should report not connected if socket not connected', () => {
      transport['connectionState'] = 'connected';
      transport['socket'] = { connected: false } as any;
  ...
  describe('Error Handling', () => {
    it('should throw error if socket not connected when emitting', () => {
      expect(() => transport['requireSocket']()).toThrow('Socket not connected');
    });
  ...
  describe('Reconnection Configuration', () => {
    it('should have default reconnection settings', () => {
      expect(transport['maxReconnectionAttempts']).toBe(5);
