...
export async function GET() {
  ...
  try {
    ...
    const mapPublicCube = (cube: CubeSummaryInput & { user?: { name?: string | null } | null }): CubeSummary =>
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const summary = normalizeCubeSummary(created ?? (cube as CubeSummaryInput), { isOwner: true });
