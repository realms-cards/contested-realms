...
const lesson: TutorialLesson = {
  ...
  initialState: {
    ...
    permanents: [
      ...
      { owner: "p1", tile: 19, card: { cardId: 106, name: "Scent Hounds", type: "Minion", cost: 2, attack: 2, defence: 2, thresholds: { earth: 1 }, slug: "bet-scent_hounds-b-s" } },
      { owner: "p2", tile: 8, card: { cardId: 301, name: "Rimland Nomads", type: "Minion", cost: 2, attack: 2, defence: 2, thresholds: { fire: 1 }, slug: "bet-rimland_nomads-b-s" } },
    ],
    phase: "Main",
    currentPlayer: "p1",
    turn: 6,
  ...
  steps: [
    ...
    },
    {
      ...
      statePatches: [
        ...
        { op: "place_permanent", permanent: { owner: "p1", tile: 8, card: { cardId: 101, name: "Amazon Warriors", type: "Minion", cost: 5, attack: 5, defence: 5, thresholds: { earth: 1 }, slug: "bet-amazon_warriors-b-s" }, tapped: true } },
      ],
    },
    {
      id: "move-encounter",
