...
const lesson: TutorialLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      text: "You control three {earth} Earth sites: Valley, Holy Ground, and Humble Village. Each features one {earth} Earth symbol. Your total {earth} Earth affinity is therefore **3**.\n\nThis elemental affinity determines which spells you can cast.",
    ...
    },
    {
      ...
      text: "The **Mountain Giant** costs {mana:8} mana and requires 4 {earth} Earth threshold. You don't have enough mana (only {mana:3}) NOR enough {earth} Earth affinity (only 3, need 4). This mighty creature demands a larger domain!",
      showCard: {
        name: "Mountain Giant",
        slug: "alp-mountain_giant-b-s",
        type: "Minion",
    ...
    },
    {
      ...
      text: "Some powerful spells require affinity with **multiple elements**. For example, a spell might need 1 {air} Air AND 2 {water} Water threshold. You'd need sites providing at least that many matching symbols.\n\nCards with multiple element thresholds count as spells of EACH of those elements.",
    },
    {
      id: "thresh-artifacts",
      type: "narration",
      title: "Artifacts: No Threshold",
      text: "Unlike other spells, **Artifacts** have no elemental threshold requirement — you only need to pay their mana cost. This makes artifacts versatile tools that any deck can use.",
      showCard: {
        name: "Torshammar Trinket",
        slug: "bet-torshammar_trinket-b-s",
        type: "Artifact",
      },
    },
    {
      ...
      hintText:
        "Select the Cave Trolls from your hand and place them on tile 18 (Valley).",
      showHint: true,
      statePatches: [
        {
