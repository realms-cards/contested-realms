...
const lesson: TutorialLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      text: "Your Avatar has a special activated ability: **\"Tap → Play or draw a site.\"**\n\nTo use it, you tap your Avatar (turn it 90°), which lets you play a site from your hand onto the board, or draw one from your Atlas.\n\n*Note: In paper play you must tap your Avatar yourself. On realms.cards the simulator taps it automatically when you play a site.*",
      showHint: true,
    },
    {
    ...
    },
    {
      ...
      hintText: "Drag the Valley from your hand onto tile 18 (center of your bottom row, where your Avatar stands).",
      showHint: true,
      statePatches: [
        { op: "remove_card_from_zone", player: "p1", zone: "hand", cardName: "Valley" },
        { op: "place_site", tile: 18, site: { owner: 1, card: { cardId: 204, name: "Valley", type: "Site", thresholds: { earth: 1 }, slug: "got-valley-pd-s" } } },
