...
export const MediaControlsPanel: React.FC<MediaControlsPanelProps> = ({
  ...
  const needsPermissions =
    !rtcState.permissionsGranted &&
    rtcState.devicePermissionStatus === "denied";
    ...
    return (
      ...
      >
        ...
        <button
          ...
          `}
          title={
            rtcState.microphoneMuted ? "Unmute microphone" : "Mute microphone"
          }
        >
          {rtcState.microphoneMuted || needsPermissions ? (
        ...
        <DeviceSelectionMenu
          ...
          selectedVideoId={
            FEATURE_AUDIO_ONLY ? null : rtcState.selectedVideoDeviceId
          }
          onAudioDeviceChange={rtcState.setAudioDevice}
          onVideoDeviceChange={
            FEATURE_AUDIO_ONLY ? () => {} : rtcState.setVideoDevice
          }
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                `}
                title={
                  rtcState.cameraDisabled ? "Enable camera" : "Disable camera"
                }
              >
                {rtcState.cameraDisabled ? (
                  <svg
