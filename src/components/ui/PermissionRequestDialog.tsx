...
export const PermissionRequestDialog: React.FC<PermissionRequestDialogProps> = ({
  ...
  useEffect(() => {
    if (isOpen && dialogRef.current) {
      const focusableElement = dialogRef.current.querySelector('button') as HTMLElement;
    ...
    switch (permissionType) {
      case 'camera':
        return {
          ...
          description: 'This application needs access to your camera to enable video chat.',
          icon: (
            <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 10.5V7a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h12a1 1 0 001-1v-3.5l4 4v-11l-4 4z"/>
            </svg>
          )
        };
      case 'microphone':
        return {
          ...
          description: 'This application needs access to your microphone to enable voice chat.',
          icon: (
            <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      default:
        return {
          ...
          description: 'This application needs access to your camera and microphone to enable video and voice chat.',
          icon: (
            <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.5-4.5L21 7M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>
            </svg>
          )
        };
    }
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ol className="list-decimal list-inside space-y-1 text-xs">
                    ...
                    <li>Click &quot;Allow&quot; or &quot;Permit&quot; to grant access</li>
