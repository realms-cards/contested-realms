  ...
  return (
    <div className="w-full max-w-[92vw] sm:max-w-6xl bg-zinc-900/80 text-white rounded-2xl ring-1 ring-white/10 p-4 sm:p-6">
        ...
        <div className="bg-black/30 rounded-xl p-4 ring-1 ring-white/10">
                  ...
                  {c.slug ? (
                    ...
                    >
                      <Image
                        ...
                        className={`${
                          isSite ? "object-cover scale-[1.35] rotate-90 origin-center" : "object-contain"
                        }`}
                        unoptimized
                      />
                    </div>
          ...
          {mulliganDrawn.p1.length > 0 && (
            <div className="mt-3">
              ...
              <div className="flex items-center gap-2 overflow-x-auto overflow-y-visible pt-8 sm:pt-12">
                    ...
                    >
                      {c.slug ? (
                        <div
                          className={`relative ${
                            isSite
                              ? "aspect-[4/3] w-28 sm:w-36 md:w-40"
                        ...
                        >
                          <Image
                            ...
                            alt={c.name}
                            fill
                            sizes={isSite ? "(max-width: 640px) 160px, 200px" : "(max-width: 640px) 80px, 100px"}
                            className={`${
                              isSite
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <button
          className="rounded bg-indigo-600/90 hover:bg-indigo-500 px-3 py-2 sm:px-4 disabled:opacity-50"
