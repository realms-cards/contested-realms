...
3. For each unclear aspect:
   → [NEEDS CLARIFICATION: Which permanent cards have burrow/submerge abilities?]
   → [NEEDS CLARIFICATION: Does burrowing affect game mechanics beyond visual positioning?]
